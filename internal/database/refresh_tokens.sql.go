...
const truncateRefreshTokensTable = `-- name: TruncateRefreshTokensTable :exec
TRUNCATE TABLE refresh_tokens CASCADE
`

func (q *Queries) TruncateRefreshTokensTable(ctx context.Context) error {
	_, err := q.db.ExecContext(ctx, truncateRefreshTokensTable)
	return err
}
